...
public class SQSDriver extends FrameworkData {
    ...
    private static void executOnResource(String resourceID, Map<String, String> deviceInfo, String tagsToExecute) {
        ...
        try {
            ...
            reportFolderName = REPORTS_PATH+"/"+ config.getProperty(PropertyConstants.PROJECT_NAME) + "_" + deviceInfo.get(PropertyConstants.DEVICE_SHORT_NAME) + "_" + Utilities.getDateAndTimeForFile();
    ...
    private static void validateAndRemoveDeviceLockfile() {
        boolean fileExists;
        String reportDir = FileUtils.getParrentFolderPath(getReportDirPath());
