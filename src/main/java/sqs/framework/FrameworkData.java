...
public class FrameworkData {
    ...
    protected static String currentScenarioId;
    ...
    protected static String reportDirPath;

    public FrameworkData(){
        setReportDirPath(PROJECT_PATH+Constants.REPORTS_PATH);
    }
    ...
    public static void setCurrentScenarioId(Scenario scenario) {
        Object[] tags = scenario.getSourceTagNames().toArray();
        currentScenarioId = (String) tags[0];
    }
}