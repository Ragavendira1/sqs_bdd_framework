...
public class FrameworkBase extends FrameworkData {
    ...
    protected static void beforeScenario(Scenario scenario) {
        ...
        setCurrentScenarioId(currentScenario);
    ...
    private static void loadTestData() {
        String test_format = config.getProperty(PropertyConstants.TEST_DATA_FORMAT);
        if(test_format.equalsIgnoreCase(Constants.JSON_FORMAT)) {
            TestDataHandler.loadJSONTestData();
        }else if(test_format.equalsIgnoreCase(Constants.EXCEL_FORMAT)){
            TestDataHandler.loadExcelTestData();
        }
    ...
    private static void initiateDriver() {
     ...
     static void initiateSeleniumWebDriver() {
