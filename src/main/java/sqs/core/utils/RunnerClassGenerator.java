...
public class RunnerClassGenerator {
    ...
    public static boolean generateRunnerClass(String featureFilePath, String tag, String reportFolderPath) throws IOException {
        ...
        try {
            String _reportFolderPath=reportFolderPath.substring(1);
            ...
            sourceCode.append("strict = false, " +
                    "features = { \"" + featureFilePath + "\" }, " +
                    "glue =  \"sqs.cucumber\","+
                    getTagsForRunner(tag) +
                    "monochrome = true, " +
                    "plugin = { \"pretty\",\r\n");
            sourceCode.append("\"html:" + _reportFolderPath + "\",\r\n");
            sourceCode.append("\"junit:" + _reportFolderPath + "/cucumber.xml\",\r\n");
            sourceCode.append("\"usage:" + _reportFolderPath + "/cucumber-usage.json\",\r\n");
            sourceCode.append("\"json:" + _reportFolderPath + "/cucumber.json\" })\r\n");
