...
import static sqs.framework.FrameworkData.PROJECT_PATH;
   ...
   static Logger logger = Logger.getLogger(DriverCapabilities.class);
    ...
    public static DesiredCapabilities setCapabilitiesDesktop()  {
        ...
        if (FrameworkData.getApplicationTypeToExecute() == ApplicationTypes.ApplicationType.DESKTOPWEB)
        {
            ...
            {
                case FIREFOX :
                    System.setProperty("webdriver.gecko.driver",PROJECT_PATH +FrameworkData.getConfig().getProperty(PropertyConstants.DRIVER_FIREFOX_PATH));
                    desiredCapabilities = DesiredCapabilities.firefox();
                    break;
                case CHROME :
                    desiredCapabilities = DesiredCapabilities.chrome();
                    if(System.getProperty("os.name").toLowerCase().contains("windows")){
                        System.setProperty("webdriver.chrome.driver",PROJECT_PATH +FrameworkData.getConfig().getProperty(PropertyConstants.DRIVER_CHROME_PATH));
                    ...
                    break;
                case IE :
                    System.setProperty("webdriver.ie.driver",PROJECT_PATH +FrameworkData.getConfig().getProperty(PropertyConstants.DRIVER_IE_PATH));
                    desiredCapabilities = DesiredCapabilities.internetExplorer();
                    break;
                case EDGE :
                    System.setProperty("webdriver.edge.driver",PROJECT_PATH +FrameworkData.getConfig().getProperty(PropertyConstants.DRIVER_EDGE_PATH));
                    desiredCapabilities = DesiredCapabilities.edge();
                    break;
                case SAFARI :
                    System.getProperty("webdriver.safari.driver", PROJECT_PATH +FrameworkData.getConfig().getProperty(PropertyConstants.DRIVER_SAFARI_PATH));
